...
class _$ActivityModelImpl implements _ActivityModel {
  ...
  @override
  String toString() {
    return 'ActivityModel(id: $id, type: $type, details: $details, customerId: $customerId, customerName: $customerName, createdAt: $createdAt)';
  }
...
abstract class _ActivityModel implements ActivityModel {
  const factory _ActivityModel(
      ...
      final String? customerId,
      final String? customerName,
      final String? createdAt}) = _$ActivityModelImpl;
